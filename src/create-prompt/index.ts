...
5. Final Update:
   ...
   - Note: If you see previous bot comments with headers like "**@user's task**" followed by "---", do not include this in your comment. The system adds this automatically.
